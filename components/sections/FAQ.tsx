...
const faqs = [
  ...
  },
  {
    ...
    a: "Обычно «не сработало» значит универсальное решение без адаптации под нишу или перестройка всех процессов, которую команда забросила. Мы настраиваем бота под вашу отрасль и подключаем к уже используемой CRM. Внедрение занимает ~14 дней, без ломки привычных процессов.",
  },
  {
